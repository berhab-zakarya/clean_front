            ...
            <div className="flex items-center space-x-4">
              {products.length > 0 && (
                <Link 
                  ...
                  className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md shadow-sm text-sm font-medium hover:bg-blue-700 transition-colors duration-200"
                >
