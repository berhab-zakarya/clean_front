...
export const CreateStore = ({ onComplete }: CreateStoreProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0f172a] via-[#1e293b] to-[#0f172a] flex flex-col">
      ...
      {/* Footer */}
      <footer className="w-full bg-[#0f172a] border-t border-white/10 py-8 px-6 mt-12">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                <Store className="h-6 w-6 text-[#6366f1]" />
                <h2 className="text-xl font-bold text-white">StoreForge</h2>
              </div>
              <p className="text-gray-400">The fastest way to launch your online business.</p>
            </div>
            <div>
          ...
          <div className="border-t border-white/10 mt-8 pt-8 text-center text-gray-400">
            <p>© 2025 StoreForge. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
