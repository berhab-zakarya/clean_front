...
// Merging all the components into one comprehensive layout
export default function MergedComponent() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-slate-950">
      {/* Grid Background - Covers the entire screen */}
      <div
        className={cn(
    ...
    />        
      ...
      {/* World Map in Footer */}
      <div className="absolute bottom-0 w-full opacity-30 z-1">
        <WorldMap
...
// World Map Component
const WorldMap = ({ dots = [], lineColor = "#0ea5e9" }) => {
  const svgRef = React.useRef(null);
  const map = new DottedMap({ height: 100, grid: "diagonal" });
  
  // Using dark theme for the map
